...
impl LanguageDetector {
    ...
    fn load_default_languages(&mut self) {
        // Rust
        self.add_language("rust".to_string(), Language {
            name: "Rust".to_string(),
        ...
        // C/C++
        self.add_language("c".to_string(), Language {
            name: "C".to_string(),
        ...
        self.add_language("cpp".to_string(), Language {
            name: "C++".to_string(),
            extensions: vec!["cpp".to_string(), "cc".to_string(), "cxx".to_string(), 
                           "hpp".to_string(), "hh".to_string(), "hxx".to_string()],
            single_line_comment: vec!["//".to_string()],
            multi_line_comment: vec![("/*".to_string(), "*/".to_string())],
            nested_comments: false,
        ...
        // Python
        self.add_language("python".to_string(), Language {
        ...
        self.add_language("javascript".to_string(), Language {
        ...
        self.add_language("typescript".to_string(), Language {
        ...
        // Java
        self.add_language("java".to_string(), Language {
            name: "Java".to_string(),
        ...
        // Go
        self.add_language("go".to_string(), Language {
            name: "Go".to_string(),
        ...
        // Ruby
        self.add_language("ruby".to_string(), Language {
            name: "Ruby".to_string(),
        ...
        // Shell
        self.add_language("shell".to_string(), Language {
        ...
        // SQL
        self.add_language("sql".to_string(), Language {
            name: "SQL".to_string(),
        ...
        // HTML
        self.add_language("html".to_string(), Language {
            name: "HTML".to_string(),
        ...
        // CSS
        self.add_language("css".to_string(), Language {
            name: "CSS".to_string(),
        ...
        // YAML
        self.add_language("yaml".to_string(), Language {
            name: "YAML".to_string(),
        ...
        // TOML
        self.add_language("toml".to_string(), Language {
            name: "TOML".to_string(),
...
impl CommentParser {
    ...
    pub fn is_in_multiline_comment(&self, line: &str, in_comment: &mut bool, depth: &mut usize) -> bool {
